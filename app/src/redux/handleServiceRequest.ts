import { addErrorMessage, addSuccessMessage, setLoading } from "./actions/dialog";
...
const handleServiceRequest = ({requestFunction, requestProps}: IHandleServiceRequestProps) => {
